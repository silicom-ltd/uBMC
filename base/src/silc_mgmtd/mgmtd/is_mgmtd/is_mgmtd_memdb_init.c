...
{"/config/radius/server/server-id/secret-tmp", MEMDB_NODE_TYPE_TEMPLATE_SUB, SILC_MGMTD_IF_LEVEL_ADMIN, SILC_MGMTD_VAR_STRING, "", is_mgmtd_radius_server_config, 10},
...
{"/config/tacacs/server/server-id/secret-tmp", MEMDB_NODE_TYPE_TEMPLATE_SUB, SILC_MGMTD_IF_LEVEL_ADMIN, SILC_MGMTD_VAR_STRING, "", is_mgmtd_tacacs_server_config, 10},
...
{"/config/snmp/agent/users/name/password-tmp", MEMDB_NODE_TYPE_TEMPLATE_SUB, SILC_MGMTD_IF_LEVEL_ADMIN, SILC_MGMTD_VAR_STRING, "", is_mgmtd_snmp_config, 10},
...
{"/config/snmp/agent/trap-hosts/ip/password-tmp", MEMDB_NODE_TYPE_TEMPLATE_SUB, SILC_MGMTD_IF_LEVEL_ADMIN, SILC_MGMTD_VAR_STRING, "", is_mgmtd_snmp_config, 10},
