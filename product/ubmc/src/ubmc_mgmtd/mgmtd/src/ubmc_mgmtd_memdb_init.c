...
{"/action/bmc/phonehome", MEMDB_NODE_TYPE_STATIC, SILC_MGMTD_IF_LEVEL_ADMIN, SILC_MGMTD_VAR_NULL, "None", is_mgmtd_bmc_action, 5},
{"/action/bmc/phonehome/enabled", MEMDB_NODE_TYPE_STATIC, SILC_MGMTD_IF_LEVEL_ADMIN, SILC_MGMTD_VAR_BOOL, "None", is_mgmtd_bmc_action, 5},
