...
struct ubmc_ipmi_sensor_thresh xs_temp_host_cpu_thresh =
{
...
struct ubmc_ipmi_sensor_thresh xs_temp_host_pcb_thresh =
{
...
struct ubmc_ipmi_sensor_thresh xs_temp_inlet_amb_thresh =
{
...
struct ubmc_ipmi_sensor_thresh xs_fan1_thresh =
{
	.lnr = FAN1_TACH_LNR,
	.lcr = FAN1_TACH_LCR,
	.lnc = FAN1_TACH_LNC,
...
struct ubmc_ipmi_sensor_thresh xs_volt_5_0_thresh =
{
	.lnr = VOLT_5_0_LNR,
	.lcr = VOLT_5_0_LCR,
	.lnc = VOLT_5_0_LNC,
...
struct ubmc_ipmi_sensor_thresh xs_volt_3_3_thresh =
{
	.lnr = VOLT_3_3_LNR,
	.lcr = VOLT_3_3_LCR,
	.lnc = VOLT_3_3_LNC,
...
struct ubmc_ipmi_sensor_thresh xs_vccsram_thresh =
{
	.lnr = VCCSRAM_LNR,
	.lcr = VCCSRAM_LCR,
	.lnc = VCCSRAM_LNC,
...
struct ubmc_ipmi_sensor_thresh xs_vccp_thresh =
{
	.lnr = VCCP_LNR,
	.lcr = VCCP_LCR,
	.lnc = VCCP_LNC,
...
struct ubmc_ipmi_sensor_thresh xs_volt_1_0_5_thresh =
{
	.lnr = VOLT_1_0_5_LNR,
	.lcr = VOLT_1_0_5_LCR,
	.lnc = VOLT_1_0_5_LNC,
...
struct ubmc_ipmi_sensor_thresh xs_mem_vddq_thresh =
{
	.lnr = MEM_VDDQ_LNR,
	.lcr = MEM_VDDQ_LCR,
	.lnc = MEM_VDDQ_LNC,
...
struct ubmc_ipmi_sensor_thresh xs_cpu_vnn_thresh =
{
	.lnr = CPU_VNN_LNR,
	.lcr = CPU_VNN_LCR,
	.lnc = CPU_VNN_LNC,
...
struct ubmc_ipmi_sensor_thresh xs_volt_1_8_thresh =
{
	.lnr = VOLT_1_8_LNR,
	.lcr = VOLT_1_8_LCR,
	.lnc = VOLT_1_8_LNC,
...
static int xs_sync_sensor_state_to_kernel(void* sensor_data ,void* ipmi_p,uint32_t value,void *output)
{
...
static int xs_sync_sensor_state_to_gui(void* sensor_data ,void* ipmi_p,uint32_t value,void *output)
{
...
static int xs_event_handler(void* sensor_data ,void* ipmi_p,uint32_t evt_flag,void *output)
{
	ubmc_sensor_event *ubmc_sensor_arry;
	int ret;
...
static int xs_update_sensor_state_callback(void* sensor_data ,void* private_date,uint32_t flag,void *output)
{
	uint32_t value = 0;
	int ret = 0;
...
struct ubmc_sensor_config_s ubmc_xsmall_sensor_cfg[XSMALL_SENSOR_MAX_NUM] =
{
		{
				...
				.sensor_id = 1,
				.sensor_thresh = &xs_temp_host_cpu_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
				.sync_sensor_gui_shm = xs_sync_sensor_state_to_gui,
				.sensor_event_handler = xs_event_handler,
				.ipmitool_factor.m	= 1,
				.ipmitool_factor.b	= 0,
		...
		},
		{
				...
				.sensor_id = 2,
				.sensor_thresh = &xs_temp_host_pcb_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
		...
		},
		{
				...
				.sensor_id = 3,
				.sensor_thresh = &xs_temp_inlet_amb_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
...
#endif
		{
				...
				.index_of_gui_array = 0,
				.sensor_id = 1,
				.sensor_thresh = &xs_volt_5_0_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
		...
		},
		{
				...
				.index_of_gui_array = 1,
				.sensor_id = 2,
				.sensor_thresh = &xs_volt_3_3_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
		...
		},
		{
				...
				.index_of_gui_array = 2,
				.sensor_id = 3,
				.sensor_thresh = &xs_vccsram_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
		...
		},
		{
				...
				.sensor_id = 5,
				.sensor_thresh = &xs_volt_1_0_5_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
		...
		},
		{
				...
				.sensor_type = UBMC_SENSOR_VOL,
				.sensor_sys_path_suffix = "",
				.sensor_name = "CPU_BRD MEMVDDQ",
				.sensor_filename_flag = 0,
				.sensor_channel_id = 5,
				.index_of_gui_array = 5,
				.sensor_id = 6,
				.sensor_thresh = &xs_mem_vddq_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
		...
		},
		{
				...
				.sensor_id = 7,
				.sensor_thresh = &xs_cpu_vnn_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
		...
		},
		{
				...
				.sensor_id = 8,
				.sensor_thresh = &xs_volt_1_8_thresh,
				.sensor_value_multiple = 1,
				.sensor_read_value_mode = FILE_MODE,
				.update_sensor_state = xs_update_sensor_state_callback,
				.sync_sensor_kernel_shm = xs_sync_sensor_state_to_kernel,
