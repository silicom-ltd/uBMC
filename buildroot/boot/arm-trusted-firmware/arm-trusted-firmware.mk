...
#ARM_TRUSTED_FIRMWARE_MAKE_OPTS += CROSS_CM3=$(HOST_DIR)/bin/arm-none-linux-gnueabi-
#ARM_TRUSTED_FIRMWARE_MAKE_OPTS += CROSS_CM3=/usr/bin/arm-linux-gnu-
#ARM_TRUSTED_FIRMWARE_MAKE_OPTS += CROSS_CM3=$(HOST_DIR)/bin/arm-none-eabi-

ARM_TRUSTED_FIRMWARE_MAKE_OPTS += CROSS_CM3=$(HOST_DIR)/bin/arm-linux-gnu-
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += a3700-utils-marvell
#Adding a CM3 toolchain for marvell to make the progress of build on centos is OK.
#This toolchain was copyed from centos gcc-arm-linux-gnu-4.8.5-16.el7.1.x86_64 and binutils-arm-linux-gnu-2.27-9.el7.1.x86_64 
#ARM_TRUSTED_FIRMWARE_DEPENDENCIES += host-arm-gnu-rm-toolchain
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += host-marvell-cm3-toolchain
endif
...
ifeq ($(BR2_TARGET_ARM_TRUSTED_FIRMWARE_INSTALL_FIPTOOL),y)
define ARM_TRUSTED_FIRMWARE_INSTALL_FIPTOOL
	if test -d $(@D)/tools/fiptool; then \
		$(INSTALL) -D -m 0755 $(@D)/tools/fiptool/fiptool $(HOST_DIR)/usr/bin/fiptool ; \
	fi
endef
endif
...
define ARM_TRUSTED_FIRMWARE_INSTALL_IMAGES_CMDS
	...
	$(ARM_TRUSTED_FIRMWARE_INSTALL_FIPTOOL)
endef
