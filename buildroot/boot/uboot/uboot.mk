...
define UBOOT_INSTALL_IMAGES_CMDS
	...
	$(if $(BR2_TARGET_UBOOT_DTB),
		cp -dpf ${BR2_TARGET_UBOOT_DTB_PATH} ${BINARIES_DIR})
	$(if $(BR2_TARGET_UBOOT_BOOT_SCRIPT),
		$(HOST_DIR)/bin/mkimage -C none -A $(MKIMAGE_ARCH) -T script \
			-d $(call qstrip,$(BR2_TARGET_UBOOT_BOOT_SCRIPT_SOURCE)) \
			$(BINARIES_DIR)/boot.scr)
	# UBMC add two more boot script for upgrade support
	$(if $(BR2_TARGET_UBOOT_BOOT_SCRIPT0),
		$(HOST_DIR)/bin/mkimage -C none -A $(MKIMAGE_ARCH) -T script \
			-d $(call qstrip,$(BR2_TARGET_UBOOT_BOOT_SCRIPT_SOURCE0)) \
			$(BINARIES_DIR)/boot0.scr)
	$(if $(BR2_TARGET_UBOOT_BOOT_SCRIPT1),
		$(HOST_DIR)/bin/mkimage -C none -A $(MKIMAGE_ARCH) -T script \
			-d $(call qstrip,$(BR2_TARGET_UBOOT_BOOT_SCRIPT_SOURCE1)) \
			$(BINARIES_DIR)/boot1.scr)
endef
