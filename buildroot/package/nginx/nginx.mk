...
define NGINX_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0664 package/nginx/nginx_ssl.crt \
		$(TARGET_DIR)/etc/nginx/nginx_ssl.crt
	$(INSTALL) -D -m 0664 package/nginx/nginx_ssl.key \
		$(TARGET_DIR)/etc/nginx/nginx_ssl.key
	$(INSTALL) -D -m 0664 package/nginx/nginx_proxy.conf \
